...
import posterImage from '@/images/IMG_9964-min.jpeg'
...
function AboutSection(props) {
  ...
  return (
    <section {...props}>
      ...
      >
        As <strong>a software engineer with 8 years of experience</strong>, I am a skilled
        professional who has a deep understanding of software development
        principles and practices. <br />
        
        With a proven track record of designing and
        developing complex software applications, I possess strong analytical
        and problem-solving skills. My expertise lies in multiple programming
        languages such as Java, Python, C++, and JavaScript, <strong>being Javascript the main languange</strong> and I am
        well-versed in various software development methodologies, including
        Agile and Waterfall. <br />
        
        I have a good understanding of software
        architecture, algorithms, and data structures, and I am passionate about
        staying up-to-date with the latest trends and technologies in the field
        of software development.
        
        <br />
        I have excellent communication and teamwork
        skills, which enable me to collaborate effectively with cross-functional
        teams, including project managers, designers, and QA engineers. I take
        pride in delivering high-quality software solutions that meet the needs
        of end-users while ensuring scalability, performance, and security.
      </p>
        ...
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
          ...
          <div className="mt-10 text-center lg:mt-12 lg:text-left">
            <p className="text-xl font-bold text-slate-900">
              <Link href="/">David Pastor</Link>
            </p>
            <p className="mt-3 text-lg font-medium leading-8 text-slate-700">
              Showcase personal/professional work over the past years working as
              Software Engineer
            </p>
          </div>
          ...
          <section className="mt-10 lg:mt-12">
            <h2 className="sr-only flex items-center font-mono text-sm font-medium leading-7 text-slate-900 lg:not-sr-only">
              <TinyWaveFormIcon
                ...
                className="h-2.5 w-2.5"
              />
              <span className="ml-2.5">Socials</span>
            </h2>
